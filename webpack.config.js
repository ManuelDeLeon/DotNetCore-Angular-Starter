  ...
  const sharedConfig = {
    ...
    module: {
      rules: [
        ...
        { test: /\.css$/, include: [path.resolve(__dirname, "ClientApp/Styles")], use: ['to-string-loader', 'css-loader'] },
        { test: /\.scss$/, include: [path.resolve(__dirname, "ClientApp/Styles")], use: ['to-string-loader', 'css-loader', 'sass-loader'] },
